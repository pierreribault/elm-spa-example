...
var $author$project$Gen$Route$Article = {$: 'Article'};
var $author$project$Gen$Route$Article__Id_ = function (a) {
	return {$: 'Article__Id_', a: a};
};
...
var $author$project$Gen$Params$Article$parser = $elm$url$Url$Parser$s('article');
var $author$project$Gen$Params$Article$Id_$Params = function (id) {
	return {id: id};
};
...
var $author$project$Gen$Params$Article$Id_$parser = A2(
	$elm$url$Url$Parser$map,
	$author$project$Gen$Params$Article$Id_$Params,
	A2(
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Article, $author$project$Gen$Params$Article$parser),
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$NotFound, $author$project$Gen$Params$NotFound$parser),
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Article__Id_, $author$project$Gen$Params$Article$Id_$parser)
	]);
...
var $author$project$Gen$Model$Article = F2(
	function (a, b) {
		return {$: 'Article', a: a, b: b};
	});
var $author$project$Gen$Msg$Article = function (a) {
	return {$: 'Article', a: a};
};
var $author$project$Gen$Model$Article__Id_ = F2(
	function (a, b) {
		return {$: 'Article__Id_', a: a, b: b};
	});
var $author$project$Gen$Msg$Article__Id_ = function (a) {
	return {$: 'Article__Id_', a: a};
};
...
var $author$project$Pages$Article$ArticlesResponse = function (a) {
	return {$: 'ArticlesResponse', a: a};
};
var $author$project$Pages$Article$Id_$Article = F4(
	function (id, title, body, userId) {
		return {body: body, id: id, title: title, userId: userId};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Pages$Article$Id_$decodeArticle = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Pages$Article$Id_$Article,
...
var $author$project$Pages$Article$decodeArticles = $elm$json$Json$Decode$list($author$project$Pages$Article$Id_$decodeArticle);
...
var $author$project$Pages$Article$getArticles = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Pages$Article$ArticlesResponse),
			$author$project$Pages$Article$decodeArticles),
		url: 'https://jsonplaceholder.typicode.com/posts'
	});
var $author$project$Pages$Article$init = _Utils_Tuple2(
	{articles: $krisajenkins$remotedata$RemoteData$Loading},
	$author$project$Pages$Article$getArticles);
var $author$project$Pages$Article$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Article$update = F2(
	function (msg, model) {
		var response = msg.a;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Pages$Article$view = function (model) {
	...
	switch (_v0.$) {
		case 'NotAsked':
			return {
				body: _List_fromArray(
					[
						$elm$html$Html$text('Initialising.')
					]),
				title: 'Initialising.'
			};
		case 'Loading':
									...
									_List_fromArray(
										[
											...
											$author$project$Gen$Route$toHref(
												$author$project$Gen$Route$Article__Id_(
													{
														id: $elm$core$String$fromInt(article.id)
													})))
										]),
									_List_fromArray(
										[
...
var $author$project$Pages$Article$page = F2(
	function (_v0, _v1) {
		return $author$project$Page$element(
			{init: $author$project$Pages$Article$init, subscriptions: $author$project$Pages$Article$subscriptions, update: $author$project$Pages$Article$update, view: $author$project$Pages$Article$view});
	});
var $author$project$Pages$Article$Id_$ArticleResponse = function (a) {
	return {$: 'ArticleResponse', a: a};
};
var $author$project$Pages$Article$Id_$getArticle = function (req) {
	return $elm$http$Http$get(
		{
			expect: A2(
				$elm$http$Http$expectJson,
				A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Pages$Article$Id_$ArticleResponse),
				$author$project$Pages$Article$Id_$decodeArticle),
			url: 'https://jsonplaceholder.typicode.com/posts/' + req.params.id
		});
};
var $author$project$Pages$Article$Id_$init = function (req) {
	return _Utils_Tuple2(
		{article: $krisajenkins$remotedata$RemoteData$Loading},
		$author$project$Pages$Article$Id_$getArticle(req));
};
var $author$project$Pages$Article$Id_$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Article$Id_$update = F2(
	function (msg, model) {
		var response = msg.a;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Pages$Article$Id_$view = function (model) {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(article.body)
									]))
							]))
					]),
				title: article.title
...
var $author$project$Pages$Article$Id_$page = F2(
	function (_v0, req) {
		return $author$project$Page$element(
			{
				init: $author$project$Pages$Article$Id_$init(req),
				subscriptions: $author$project$Pages$Article$Id_$subscriptions,
				update: $author$project$Pages$Article$Id_$update,
				view: $author$project$Pages$Article$Id_$view
			});
	});
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href(
							$author$project$Gen$Route$toHref($author$project$Gen$Route$Article))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Voir tous nos articles !')
						]))
				]))
		]),
	title: 'Homepage'
...
var $author$project$Gen$Pages$pages = {
	article: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Article$page, $author$project$Gen$Model$Article, $author$project$Gen$Msg$Article),
	article__id_: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Article$Id_$page, $author$project$Gen$Model$Article__Id_, $author$project$Gen$Msg$Article__Id_),
...
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		case 'Article':
			return $author$project$Gen$Pages$pages.article.init(_Utils_Tuple0);
		case 'Home_':
			return $author$project$Gen$Pages$pages.home_.init(_Utils_Tuple0);
		case 'Article__Id_':
			var params = route.a;
			return $author$project$Gen$Pages$pages.article__id_.init(params);
		default:
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Article':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.article.subscriptions, params, model);
		case 'Home_':
			var params = model_.a;
		...
		case 'Article__Id_':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.article__id_.subscriptions, params, model);
		default:
			var params = model_.a;
		...
		while (true) {
			if (_v0.a.$ === 'Article') {
				if (_v0.b.$ === 'Article') {
					...
					var params = _v1.a;
					var model = _v1.b;
					return A3($author$project$Gen$Pages$pages.article.update, params, msg, model);
				} else {
					break _v0$2;
				}
			} else {
				if (_v0.b.$ === 'Article__Id_') {
					var msg = _v0.a.a;
					var _v2 = _v0.b;
					var params = _v2.a;
					var model = _v2.b;
					return A3($author$project$Gen$Pages$pages.article__id_.update, params, msg, model);
				} else {
					break _v0$2;
				}
			}
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Article':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.article.view, params, model);
		case 'Home_':
			var params = model_.a;
		...
		case 'Article__Id_':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.article__id_.view, params, model);
		default:
			var params = model_.a;
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Gen.Pages.Msg":{"args":[],"type":"Gen.Msg.Msg"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.Article.Id_.Article":{"args":[],"type":"{ id : Basics.Int, title : String.String, body : String.String, userId : Basics.Int }"},"Pages.Article.Articles":{"args":[],"type":"List.List Pages.Article.Id_.Article"},"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangedUrl":["Url.Url"],"ClickedLink":["Browser.UrlRequest"],"Shared":["Shared.Msg"],"Page":["Gen.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Gen.Msg.Msg":{"args":[],"tags":{"Article":["Pages.Article.Msg"],"Article__Id_":["Pages.Article.Id_.Msg"]}},"Shared.Msg":{"args":[],"tags":{"NoOp":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.Article.Msg":{"args":[],"tags":{"ArticlesResponse":["RemoteData.WebData Pages.Article.Articles"]}},"Pages.Article.Id_.Msg":{"args":[],"tags":{"ArticleResponse":["RemoteData.WebData Pages.Article.Id_.Article"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"List.List":{"args":["a"],"tags":{}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}}}}})}});}(this));